...
namespace SharpGis.SharpGps.NTRIP
{
    ...
    /*
        ...
        Content-Length: 557
        Date: 22/Dec/2013:09:31:53 UTC

        STR;RTKCMRPLUS;RTKCMR+;CMR+;Obs(1),Info(10),PrsInfo(11);2;GPS+GLONASS;SNCORS;CHN;0;0;1;1;Trimble GPSNet;SXDZJVRS;B;N;0;;
        STR;RTKRTCM23;RTKRTCM2.3;RTCM 2.3;1(1),3(10),18(1),19(1);2;GPS+GLONASS;SNCORS;CHN;0;0;1;1;Trimble GPSNet;SXDZJVRS;B;N;0;;
        STR;DGPSRTCM23;DGPSRTCM2.3;RTCM 2.3;1(1),3(10),20(1),21(1);2;GPS+GLONASS;SNCORS;CHN;0;0;1;1;Trimble GPSNet;SXDZJVRS;B;N;0;;
        STR;RTKRTCM31;RTKRTCM31;RTCM 3;1004(1),1005/1007(5),1014(1, 1 msgs),1015(1, all msgs),1016(1, all msgs);2;GPS+GLONASS;SNCORS;CHN;0;0;1;1;Trimble GPSNet;SXSDZJVRS;B;N;0;;
        ENDSOURCETABLE
     */
    //STR;MountPoint;Identifier;Format;FormatDetails;Carrier;NavSystem;Network;Country;Latitude;Longitude;NeedNMEAPos;Solution;Generator;Compression;Authentication;Fee;BitRate;Miscellanous
