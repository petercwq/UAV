...
{
    class MWGUIControl : System.Windows.Forms.Control
    {
...
//            pe.Graphics.DrawImage(img, (ptImg.X + deltaXRot + deltaXTrs) * scaleFactor, (ptImg.Y + deltaYRot + deltaYTrs) * scaleFactor, img.Width * scaleFactor, img.Height * scaleFactor);
            pe.Graphics.DrawImageUnscaled(img, (int)(ptImg.X + deltaXRot + deltaXTrs) , (int)(ptImg.Y + deltaYRot + deltaYTrs) , img.Width, img.Height);
